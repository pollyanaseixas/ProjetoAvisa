...
test.describe('Backoffice - SISAMB', () => {
  ...
  test.beforeEach(async ({ page }) => {
    // 1. Acessa a página antes de cada teste deste grupo.
    await page.goto('https://bahia-test.pglsmais.com.br/sisamb/backoffice/');
  });
  

  test('Deve exibir o formulário de login na tela inicial', async ({ page }) => {
    // 2. Adiciona uma validação real para o primeiro teste.
